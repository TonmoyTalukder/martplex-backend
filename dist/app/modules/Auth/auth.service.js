...
const forgotPassword = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const resetPassLink = `${config_1.default.frontend_url}/reset-pass?userId=${userData.id}&token=${resetPasswordToken}`;
...
const resetPassword = (token, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isValidToken = jwtHelpers_1.jwtHelpers.verifyToken(token, config_1.default.jwt.reset_password_token);
    if (!isValidToken) {
