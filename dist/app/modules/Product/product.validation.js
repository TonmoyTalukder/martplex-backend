...
exports.productValidation = exports.softDeleteProductSchema = exports.getProductByIDSchema = exports.createProductSchema = void 0;
...
const updateProductSchema = zod_1.z.object({
    id: zod_1.z.string().uuid('Invalid product ID').nonempty('Product ID is required'),
    name: zod_1.z
        .string()
        .min(3, 'Name must have at least 3 characters')
        .max(100, 'Name cannot exceed 100 characters')
...
exports.softDeleteProductSchema = zod_1.z.object({
...
exports.productValidation = {
    ...
    updateProductSchema,
    softDeleteProductSchema: exports.softDeleteProductSchema,
};
